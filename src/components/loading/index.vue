...
.swing-l {
  animation: ball-l .525s ease-in-out infinite alternate;
}
.swing-r {
  animation: ball-r .525s ease-in-out infinite alternate;
}
.shadow-l {
  animation: shadow-l-n .525s ease-in-out infinite alternate;
}
.shadow-r {
  animation: shadow-r-n .525s ease-in-out infinite alternate;
}
</style>